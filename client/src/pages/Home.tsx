    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center p-4 bg-background border border-border rounded-full shadow-2xl mb-6 ring-4 ring-red-500/20 relative group">
            <div className="absolute inset-0 bg-primary/10 rounded-full animate-pulse group-hover:bg-primary/20 transition-colors" />
            <Search className="w-10 h-10 text-primary relative z-10 drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]" strokeWidth={3} />
